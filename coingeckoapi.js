...
// const Prueba = await ObtenerInfoExtraMonedas();
// Prueba.map((InfoMoneda,indice) => {
//     console.log(InfoMoneda.name + ' Indice ' + indice);
//     console.log(InfoMoneda.symbol);
//     console.log(InfoMoneda.ath);
//     console.log(InfoMoneda.ath_change_percentage);
//     console.log(InfoMoneda.market_cap_rank);
//     console.log('////////////////////////////');
// });
...
// const ListaMonedasCoingecko = await ObtenerListadoMonedasCoingecko();
// ListaMonedasCoingecko.map((MonedaListada) => {
//     // console.log("id: ", MonedaListada.id, " Symbol: " , MonedaListada.symbol);
//     if ( MonedaListada.symbol === 'aave') {
//         console.log("id: ", MonedaListada.id, " Symbol: " , MonedaListada.symbol);
//     };
// });


// console.log(ListaMonedasCoingecko[1].id);
// console.log(ListaMonedasCoingecko.length);

// const ListaMonedasBinance = await ObtenerListadoMonedasBinance();
// console.log(ListaMonedasBinance);
// console.log(ListaMonedasBinance.tickers.length);
// console.log(ListaMonedasBinance.tickers);
// console.log(ListaMonedasBinance.tickers[99].coin_id);