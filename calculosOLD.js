...
// Pendiente el catch de error
    ...
    let now = new Date();
    console.log( "Fecha actual UTC: ", now );
...
// Pendiente el catch de error
    ...
    InfoActual.map( ( InfoMonedaListada , Posicion ) => {
        ...
        // Aqui descartamos las monedas que NO queremos operar. DEFIUSDT , ETHUSDT_220930 , BTCUSDT_220930 y BTCDOMUSDT.
        if ( InfoMonedaListada.symbol != 'DEFIUSDT' && InfoMonedaListada.symbol != 'ETHUSDT_220930' && InfoMonedaListada.symbol != 'BTCUSDT_220930' && InfoMonedaListada.symbol != 'BTCDOMUSDT' ) {
            ...
            // console.log("Moneda en Estudio: " , MonedaEstudio , " " , Posicion );
...
// Por alguna razon el arreglo devuelto es de la forma [ [ Objeto1, Objeto2, ... , ObjetoN] ]
            ...
            // console.log("Volumen de las últimas 24 horas (MM): " , Volumen24HorasMM );
            ...
            // console.log("Variación % del precio en las últimas 24 horas: " , VariacionPorcentual24Horas );
            ...
            if ( InicioVela >= InfoMonedaListada.price ) {
                if ( CierreVela >= InfoMonedaListada.price ) {
                    ...
                    // console.log("Sentido del movimiento: Bajista.");
                } else {
                    SentidoMovimiento = 1; // Alcista-VelaRoja
                    // console.log("Sentido del movimiento: Alcista-VelaRoja.");
                };
            } else {
                if ( CierreVela <= InfoMonedaListada.price ) {
                    SentidoMovimiento = 1; // Alcista
                    // console.log("Sentido del movimiento: Alcista.");
                } else {
                    SentidoMovimiento = 0; // Bajista-VelaVerde
                    // console.log("Sentido del movimiento: Bajista-VelaVerde.");
                };
            };
            ...
            // console.log(`Variación % del Precio en los últimos ${LimiteEstudio} minutos: `, VariacionPorcentual);
            ...
            // Variable usada para mostrar la informacion extraida de Coingecko una vez filtrada.
            let CoincidenciaCorrecta = false;
            InfoExtraCoingecko.map((InfoMoneda) => {
                // Filtra los simbolos que no son iguales en Coingecko.
                ...
                if ( CoincidenciaCorrecta ) {
                    ...
                    // priceChangePercent30min: Variacion porcentual del precio de la Criptomoneda, en los ultimos 30 minutos.
                    // priceChangePercent24hr: Variacion porcentual del precio de la Criptomoneda, en las ultimas 24 horas.
                    // volumeChange24hr: Volumen de negociacion de la Criptomoneda (en millones de USDT o BUSD) durante las ultimas 24 horas.
                    // name: Nombre de la Criptomoneda.
                    // ath: Maximo historico.
                    // ath_change_percentage: Distancia porcentual desde el Precio actual al ATH.
                    // market_cap_rank: Posicion general de la Criptomoneda segun su market cap.
                    ...
                    // console.log('Nombre Moneda: ' , InfoMoneda.name);
                    // console.log('ATH: ' , InfoMoneda.ath);
                    // console.log('ATH (%): ' , InfoMoneda.ath_change_percentage);
                    // console.log('Ranking: ' , InfoMoneda.market_cap_rank);
    ...
    // Si el registro es nuevo se crea, si el registro existe se actualiza.
